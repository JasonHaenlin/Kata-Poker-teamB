...
public class HandTest {
    ...
    public void testDoublePair() {
        ...
        assertEquals(9, hand5.getPatternValue().getValue());
        assertEquals(7, hand5.getPatternValueExtra().getValue());

        hand6.buildNewHand(new ArrayList<>(Arrays.asList("7Tr", "7Pi", "9Ca", "10Pi", "10Ca")));
        assertEquals(true, hand6.isDoublePairDetected());
        assertEquals(10, hand6.getPatternValue().getValue());
        assertEquals(7, hand6.getPatternValueExtra().getValue());
